...
const BudgetItem = ({ budget, showDelete = false }) => {
    ...
    return (
        <div className='w-full block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-6'>
            ...
            <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700  my-3">
                <div class="bg-blue-600 h-2.5 rounded-full dark:bg-blue-500" style={{ width: `${formstPercentage(spent / amount)}` }}></div>
            </div>
